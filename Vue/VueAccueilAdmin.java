...
public class VueAccueilAdmin extends JFrame {
    ...
    private JButton boutonUtilisateursReservations;
    ...
    public VueAccueilAdmin() {
        ...
        boutonUtilisateursReservations = createButton("Gérer Utilisateurs et Réservations", "UTILISATEURS_RESERVATIONS");
        boutonStatistiques = createButton("Voir les Statistiques", "VOIR_STATS");

        // Bouton de déconnexion
        boutonDeconnexion = new JButton("Déconnexion");
        boutonDeconnexion.setFont(policeNormale);
        boutonDeconnexion.setBackground(new Color(217, 83, 79));
        ...
        panelBoutons.add(Box.createRigidArea(new Dimension(0, 10)));
        panelBoutons.add(boutonUtilisateursReservations);
        panelBoutons.add(Box.createRigidArea(new Dimension(0, 10)));
    ...
    public void ajouterEcouteur(ActionListener listener) {
        ...
        boutonUtilisateursReservations.addActionListener(listener);
        boutonStatistiques.addActionListener(listener);
